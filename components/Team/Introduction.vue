        ...
        <div id="box">
            ...
            <div id="content">
                <div id="content-wrapper">
                    <div class="persons">
                        <div class="person">
                            <img class="person-image" src="/Sabitha Sarah2.png" />
                        ...
                        <div class="person">
                            <img class="person-image" src="/Syahsabili Fithra2.png" />
                            <div class="person-text">
                    ...
                    <div class="persons">
                        <div class="person">
                            <img class="person-image" src="/Ibnu Adha2.png" />
                            <div class="person-text">
                        ...
                        <div class="person">
                            <img class="person-image" src="/Farid Alvaro2.png" />
                            <div class="person-text">
...
<style scoped>
    ...
    #team-text {
        font: bold 3em 'Montagu Slab';
        text-align: center;
    }

    #team-text > span:first-child {
        color: #FF8854;
    }

    #team-text > span:nth-child(2) {
        color: #C3807A;
    }

    #team-text > span:nth-child(3) {
        color: #EE6699;
    }
    
    #team-text > span:nth-child(4) {
        color: #C85146;
    }

    #team-text > span:nth-child(5) {
        color: #AEF6F7;
    }

    #team-text > span:nth-child(6) {
        color: #812C35;
    }

    #team-text > span:last-child {
        color: #50A060;
    }

    .persons, .person, .person-text {
        display: flex;
    }
